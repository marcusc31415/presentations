...
\begin{center}
\parbox{9cm}{\noindent{}\justifying{
                Let $\Delta = (\Gamma, (X_{a}), (G(v)))$ be a local action diagram, $\mathbf T = (T, \pi, \calL)$ be a $\Delta$-tree, and $G:=\mathbf U(\mathbf{T},(G(v)))\le\operatorname{Aut}_{\pi}(T)$. If $G$ is of type
